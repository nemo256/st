 ...
 */
static char *font = "FiraCode Nerd Font:size=17:antialias=true:autohint=true:style=Bold";
/* Spare fonts */
static char *font2[] = {};
 ...
 * attribute.
 */
static unsigned int blinktimeout = 279;
...
/* static char *fzf[] = { "/bin/sh", "-c", "fzf", "externalpipe", NULL }; */
...
static Shortcut shortcuts[] = {
	...
	/* { MODKEY,               XK_f,           externalpipe,   {.v = fzf } }, */
